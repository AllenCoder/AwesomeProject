...
var StoryItem = React.createClass({
    ...
    render: function () {
        ...
        if (this.props.story.images && this.props.story.images[0]) {
            image = <Image source={{uri: this.props.story.images[0]}} style={styles.cellImage}/>
        }
        return (
            <View {...this.props}>
                <TouchableElement onPress={this.updateReadState}
                                  onShowUnderlay={this.props.onHighlight}
                                  onHideUnderlay={this.props.onUnHighlight}>
                    <View style={styles.row}>
                        <Text ref={TITLE_REF} style={this.props.story.read?styles.storyTitleRead:styles.storyTitle}
                              numberOfLines={3}>
